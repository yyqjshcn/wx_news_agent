...
import { Filter, ExternalLink, Rss, MessageSquare, FileText, ChevronDown, ChevronUp } from "lucide-react";
  ...
  return (
    <Fragment>
      <tr className="hover:bg-gray-50">
        ...
        <td className="px-4 py-3 text-gray-600 whitespace-nowrap">{article.account_name}</td>
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50 border-b">
            <tr>
              ...
              <th className="text-left px-4 py-3 font-medium text-gray-500 whitespace-nowrap">来源</th>
              <th className="text-left px-4 py-3 font-medium text-gray-500 whitespace-nowrap">类型</th>
              <th className="text-left px-4 py-3 font-medium text-gray-500 whitespace-nowrap">相关性</th>
              <th className="text-left px-4 py-3 font-medium text-gray-500 whitespace-nowrap">事件</th>
              <th className="text-left px-4 py-3 font-medium text-gray-500 whitespace-nowrap">摘要</th>
